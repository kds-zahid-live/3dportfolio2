    ...
    >
      ...
      >
        ...
        <div className="mt-5 contact__options">
          ...
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=88018000000000&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +88018000000000
            </a>
          </article>
        </div>
