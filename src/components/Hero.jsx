...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: ['Web Designer', "Web Developer", " Mentor ", " Content Writer ",'Software Developer ','3D Artist','2D Animator','3D Animator','SEO Specialist','WordPress Developer','Full Stack Developer', " Tech Enthusiast "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>KDS Zahid</p>
          </h1>
          <h3>
